...
const FavoriteItem = ({ imgSrc, name }) => (
  <div className="flex items-center p-4 bg-gradient-to-br from-slate-50 to-slate-200 rounded-lg mb-2 cursor-pointer hover:shadow-md">
...
const FavoritesContainer = ({ favorites = {} }) => {
  ...
  return (
    <div className="favorites-container bg-gradient-to-br from-sky-500 to-sky-300 p-6 rounded-lg shadow-lg mt-4">
      <div className="tabs flex justify-center mb-6 gap-4">
